      ...
      <ul class="property-bookmark">
        <li class="property-price">
          <strong>
                        ...
                        <?php if( $property_price_day_low = get_post_meta($id_property, 'property_price_day_low',true)): ?>
                            <?php echo get_option('colabs_currency_symbol').' '.number_format( $property_price ); ?>
                        <?php endif; ?>
                        <?php if( $property_price_day_med = get_post_meta($id_property, 'property_price_day_med',true)): ?>
                            <?php echo get_option('colabs_currency_symbol').' '.number_format( $property_price ); ?>
                        <?php endif; ?>
                        <?php if( $property_price_day_high = get_post_meta($id_property, 'property_price_day_high',true)): ?>
                            <?php echo get_option('colabs_currency_symbol').' '.number_format( $property_price ); ?>
                        <?php endif; ?>
                        <?php if( $property_price_week_low = get_post_meta($id_property, 'property_price_week_low',true)): ?>
                            <?php echo get_option('colabs_currency_symbol').' '.number_format( $property_price ); ?>
                        <?php endif; ?>
                        <?php if( $property_price_week_med = get_post_meta($id_property, 'property_price_week_med',true)): ?>
                            <?php echo get_option('colabs_currency_symbol').' '.number_format( $property_price ); ?>
                        <?php endif; ?>
                        <?php if( $property_price_week_high = get_post_meta($id_property, 'property_price_week_high',true)): ?>
                            <?php echo get_option('colabs_currency_symbol').' '.number_format( $property_price ); ?>
                        <?php endif; ?>
					</strong>
        </li>
