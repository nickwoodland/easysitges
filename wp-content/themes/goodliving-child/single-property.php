...
<div class="single-prop-top clearfix">
	...
	<div class="history-link">
		<a onclick="window.history.back()" href="#">&lt;&lt; Back to Search Results</a>
	</div>
...
<div class="main-content column col9">
	<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
		...
		$size_external = get_post_meta($id, 'property_size_external',true);
				...
				<div class="property-info-panel" id="property-facilities">
					<?php
						 echo '<ul class="property-facility">';
							if($size!='') echo '<li class="prop-size"><span>Internal</span><br  /><span>'.$size.' '.__("m²","colabsthemes").'</span></li>';
							if($size_external!='') echo '<li class="prop-size-external"><span>External</span><br  /><span>'.$size_external.' '.__("m²","colabsthemes").'</span></li>';
