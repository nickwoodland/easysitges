...
<form class="advance-search clearfix <?php echo $price_panel_form_class; ?>" name="property-search" id="property-search" method="get" action="<?php echo home_url('/'); ?>/">
  <div class="column col9">
	...
	<?php /*	<?php
	  ...
	  ?>
    <div class="input-text column col4 input-search">
...
<!--
    <div class="price-slider-amount">
      ...
      <input type="text" class="max-price" id="max_price" name="price_max" data-max="<?php echo $max_price_properties;?>" placeholder="<?php _e('Max Price','colabsthemes');?>" value="<?php echo ( $price_max != '' ? $price_max : $max_price_properties); ?>">
    </div> -->
    ...
    <?php if (isset($_GET['price_max'])) { $price_max = $_GET['price_max'];  } else { $price_max = 'all';  } ?>

    <?php
    $options_features_amount = array("100000","200000","300000","400000","500000","600000","700000","800000","900000","1000000","2000000","3000000","4000000","5000000","10000000");
    $rental_ids = array("142", "23", "22");
    $default_text = 'Max Price';
    if (in_array($_GET['property_types'], $rental_ids)) {
      $default_text = 'Max Monthly Rent';
      $options_features_amount = array();
      for ($i = 5; $i < 10; $i++) {
        $j = $i * 100;
        array_push($options_features_amount, $j);
      }
      for ($i = 10; $i < 30; $i+=2) {
        $j = $i * 100;
        array_push($options_features_amount, $j);
    ...
    <div class="input-select column col4">
      <select class="postform" id="price_max" name="price_max">
        <option <?php if ($price_max == 'all') { ?>selected="selected"<?php }?> value="all"><?php $default_text ?></option>
    ...
    <?php /*<div class="column col5 alpha">
      <?php
    ...
    <?php /*<div class="input-select additional-field column col7">
      ...
      /*
            ...
            $max_price_properties = 10000000;

            if (isset($_GET['property_types'])):

                if($_GET['property_types'] == 23 && $price_max > 1000):
                    if($price_max > 1000):
                        $price_max = 1000;
                    endif;
                    $max_price_properties = 1000;
                endif;

                if($_GET['property_types'] == 22):
                    if($price_max > 10000):
                        $price_max = 10000;
                    endif;
                    $max_price_properties = 10000;
                endif;

            endif;
        */

			//if($max_price_properties == '')$max_price_properties = 10000000;
			?>

<?php
/*
                <div class="input-slider column col12">
...
?>
                ...
                <?php /*<div class="input-slider column col6 property-size">
                    <?php
  ...
  <div class="column col3">
    ...
    <?php /* <div class="advance-search-button">
      <a href="#show" class="show button button-bold button-orange"><?php echo get_option('colabs_label_advanced_search');?></a>
      <a href="#hide" class="hide button button-bold button-orange"><?php echo get_option('colabs_label_hide_advanced_search');?></a>
    </div> */ ?>
  </div>
