...
$colabs_metaboxes[] = array (  "name"  => "colabs_email_agent",
					            "std"  => "",
					            "label" => __("Agent Email Address","colabsthemes"),
					            "type" => "text",
					            "desc" => __("Enter your email agent.","colabsthemes"));

$colabs_metaboxes[] = array (  "name"  => "colabs_number_agent",
					            "std"  => "",
					            "label" => __("Agent Primary Contact Number","colabsthemes"),
					            "type" => "text",
					            "desc" => __("Enter your agents primary contact number.","colabsthemes"));

$colabs_metaboxes[] = array (  "name"  => "colabs_number_secondary_agent",
					            "std"  => "",
					            "label" => __("Agent Secondary Contact Number","colabsthemes"),
					            "type" => "text",
					            "desc" => __("Enter your agents secondary contact number.","colabsthemes"));

$colabs_metaboxes[] = array (  "name"  => "colabs_fax_agent",
					            "std"  => "",
					            "label" => __("Agent Fax","colabsthemes"),
					            "type" => "text",
					            "desc" => __("Enter your agents fax.","colabsthemes"));

$colabs_metaboxes[] = array (  "name"  => "colabs_address_agent",
					            "std"  => "",
					            "label" => __("Agent Address","colabsthemes"),
					            "type" => "text",
