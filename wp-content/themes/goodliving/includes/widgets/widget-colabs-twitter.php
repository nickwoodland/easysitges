...
class CoLabs_Twitter extends WP_Widget {
  ...
  function __construct() {
    ...
    parent::__construct( false, __('Colorlabs - Twitter Stream', 'colabsthemes'), $widget_ops );
  }
  ...
  function get_user_timeline( $username = '', $limit = 5 ) {
    ...
    if ($timeline !== false) {
      ...
      $timeline_url = "https://api.twitter.com/1.1/statuses/user_timeline.json?screen_name={$username}&count={$limit}";
      $args = array(
        'headers' => $headers,
        'timeout' => 20,
        'sslverify' => false
      );
      $response = wp_remote_get($timeline_url, $args );
