...
<div class="navbar container">
  <div class="row">
		<a href="<?php echo get_permalink(get_option('colabs_submit_url'));?>" class="button button-green button-bold submit-listing"><i class="icon-cloud-download"></i> <?php _e('Submit Listing','colabsthemes');?></a>
